...
public class UpdateActivity extends AppCompatActivity {
    ...
    String id, title, progress, members;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        members_input = findViewById(R.id.members_input2);
        ...
        update_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                members = members_input.getText().toString().trim();
                myDB.updateData(id, title, progress, members);
            }
        });
    ...
    void getAndSetIntentData(){
        if(getIntent().hasExtra("id") && getIntent().hasExtra("title") &&
                getIntent().hasExtra("progress") && getIntent().hasExtra("members")){
            ...
            members_input.setText(members);
            Log.d("stev", title+" "+progress+" "+members);
        }else{
